            ...
            <div class="col-md-8">
                <div class="card shadow-sm rounded">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0 fw-bold">Chỉnh sửa danh mục</h5>
                        ...
                        <form method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    @error('icon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div id="imagePreview" class="mt-2 {{ $category->icon ? '' : 'd-none' }}">
                                        @if($category->icon)
                                            @php
                                            ...
                                            @else
                                                <div class="text-muted">Ảnh không tồn tại</div>
                                            @endif
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="is_active"
                                        ...
                                        <option value="1" {{ old('is_active', $category->is_active) == 1 ? 'selected' : '' }}>Đang hoạt động</option>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-check-circle me-1"></i> Cập nhật
                                </button>
                            </div>
                        </form>
                    </div>
