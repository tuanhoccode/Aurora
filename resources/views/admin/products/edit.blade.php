...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 fw-bold text-gray-800">Cập nhật sản phẩm</h1>
            <p class="text-muted mt-1">Chỉnh sửa thông tin sản phẩm trong hệ thống</p>
        </div>
        <div>
    ...
    @if($errors->any())
        <div class="alert alert-danger alert-dismissible fade show rounded shadow-sm" role="alert">
            <i class="fas fa-exclamation-triangle me-2"></i> Có lỗi xảy ra, vui lòng kiểm tra lại!
            <ul class="mb-0 mt-2">
    ...
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card shadow-sm rounded mb-4">
                    <div class="card-header bg-light fw-bold">Cài đặt</div>
                    <div class="card-body">
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ route('admin.products.index') }}" class="btn btn-secondary rounded-pill me-2 shadow-sm"><i class="fas fa-times me-1"></i> Huỷ</a>
            <button type="submit" class="btn btn-outline-primary rounded-pill me-2 shadow-sm" name="save_draft" value="1"><i class="fas fa-save me-1"></i> Lưu nháp</button>
            <button type="submit" class="btn btn-primary rounded-pill shadow-sm"><i class="fas fa-save me-1"></i> Lưu sản phẩm</button>
        </div>
    </form>
</div>
@push('styles')
