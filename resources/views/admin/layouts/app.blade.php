...
<head>
    ...
    <style>
        ...
        h1, h3, h6 {
            font-family: 'Poppins', sans-serif;
            font-weight: 700;
            color: #5a5c69; /* A slightly softer dark color */
            opacity: 1; /* Make headings always visible */
            animation: none; /* Remove fade-in animation for headings */
        }

        h1 {
            font-size: 1.75rem; /* Adjusted main heading size */
            margin-bottom: 1.5rem; /* Adjusted margin below main heading */
        }

         h3 {
             font-size: 1.5rem; /* Adjusted subheading size */
             margin-bottom: 1rem; /* Adjusted margin below subheading */
         }

         h6 {
             font-size: 1rem; /* Adjusted small heading size */
             margin-bottom: 0.75rem; /* Adjusted margin below small heading */
         }

        .card {
            border: none; /* Remove default border */
            border-radius: 0.5rem; /* Slightly less rounded corners for a cleaner look */
        ...
        .table thead th {
            ...
            font-size: 0.85rem;
             padding: 0.75rem; /* Adjust padding in headers */
        }

         /* Style for table rows on hover */
        .table tbody tr:hover {
            background-color: #f1f1f1; /* Lighter highlight on hover */
            transition: background-color 0.2s ease-in-out;
        }

        /* Style for table cells */
        .table td, .table th {
             padding: 0.75rem; /* Adjust padding in cells */
             vertical-align: middle; /* Align content vertically */
        }

        /* Add subtle border to table cells */
        .table td {
            border-top: 1px solid #e9ecef; /* Subtle top border for cells */
        }
        ...
        .table td .btn-group, .table td form {
            margin-bottom: 0;
            display: flex; /* Use flexbox for alignment */
            align-items: center; /* Center items vertically */
            gap: 5px; /* Space between buttons/elements */
        }

         /* Style for table headers */
        .table thead th {
             border-bottom: 2px solid #d1d3e2; /* Slightly darker border */
             font-weight: 600; /* Slightly less bold */
             color: #6e707e; /* Darker header text color */
             text-transform: uppercase;
        ...
        .card-body .form-group {
             margin-bottom: 1rem; /* Adjusted vertical spacing in forms */
        }
        ...
        /* Adjust margin for form groups specifically within Bootstrap columns to avoid double margin */
         ...
         .card-body .row > [class^="col-"] > .form-group {
             margin-bottom: 0; /* Remove bottom margin here, as row/col handles spacing */
             padding-bottom: 1rem; /* Use padding for spacing within the row/col structure */
         }
        ...
        .table .btn-group .btn {
            margin-right: 5px; /* Small horizontal space between buttons */
            &:last-child {
        ...
        .card-body form.mb-4 button[type="submit"].btn-primary {
             margin-top: 1.8rem; /* Adjust this value to align with form controls */
        }
        ...
        .card-body form.row.g-3 .col-md-1.d-flex.align-items-end .btn {
             margin-top: 0; /* Reset any conflicting margin-top */
    ...
    .sidebar-animated {
        ...
        /* background: #58a4b0; */ /* Using a pleasant teal color */
        /* Trying a new, modern gradient */
        /* background: linear-gradient(to bottom, #6dd5ed 0%, #2193b0 100%); */ /* Blue/Teal gradient */
        /* Applying a dark to light gradient */
        background: linear-gradient(to bottom, #1a2a6c 0%, #b21f1f 50%, #fdbb2d 100%); /* Example: Deep blue to light orange-yellow */
        background-size: 100% 100%;
        /* animation: gradientAnimation 10s ease infinite; */

        min-height: 100vh; /* Kept for structure, overflow handles scrolling */
        box-shadow: 0 5px 25px rgba(0,0,0,0.15); /* Adjusted shadow */
    ...
    .sidebar-animated::-webkit-scrollbar { /* Hide scrollbar for Chrome, Safari and Opera */
        display: none;
    }
    ...
    .sidebar-animated {
         ...
         animation: sidebarSlideIn 0.7s cubic-bezier(.25,.8,.25,1) forwards; /* Applied animation */
    ...
    .sidebar-animated .nav-link {
        ...
        transition: all 0.3s ease; /* Slightly longer transition for smoother effects */
        display: flex;
        align-items: center;
        gap: 0.7rem;
    ...
    /* Hover/Active Effect */
     .sidebar-animated .nav-link:hover {
         ...
         background: rgba(255, 255, 255, 0.2) !important; /* More visible semi-transparent white background on hover */
         transform: translateY(-2px); /* Subtle lift effect on hover */
         box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Subtle shadow on hover */
     }
      .sidebar-animated .nav-link.active {
         color: #fff !important; /* White text on active */
         background: rgba(255, 255, 255, 0.3) !important; /* More prominent semi-transparent white background on active */
         font-weight: 500; /* Slightly bolder on active */
         transform: none;
         box-shadow: none;
     }
    ...
    .sidebar-animated .nav-link:hover .nav-icon {
     ...
     .sidebar-animated .nav-link.active .nav-icon {
         transform: none; /* Remove scale on active */
         color: #fff !important; /* White icon on active */
     }

     /* Sidebar Heading Styles */
    .sidebar-animated .sidebar-heading {
        color: rgba(255, 255, 255, 0.5) !important; /* Lighter heading color */
        font-size: 0.8rem;
        font-weight: 500;
    ...
    /* Divider Style */
    .sidebar-animated hr {
        border-top: 1px solid rgba(255, 255, 255, 0.1) !important; /* Subtle white divider */
     ...
     @media (min-width: 992px) {
         body.sidebar-toggled .sidebar-animated {
             width: 100px; /* Collapsed width */
              border-radius: 0 20px 20px 0; /* Smaller border radius when collapsed */
         }
          body.sidebar-toggled #content-wrapper {
    ...
    <style>
        ...
        .form-select {
             ...
             border-color: #ced4da; /* Adjusted border color */
             box-shadow: none;
             transition: all 0.3s ease;
        ...
        .form-select:focus {
            ...
            box-shadow: 0 0 0 0.25rem rgba(0, 123, 255, 0.25); /* Add a subtle glow on focus */
        }
        ...
        .small-box h3 {
            ...
            white-space: nowrap;
            padding: 0;
             color: #fff !important; /* Ensure heading color is white */
             opacity: 1;
             animation: none;
        }
        ...
        .small-box .icon {
            ...
            color: rgba(0, 0, 0, 0.1); /* Softer icon color */
            transition: all 0.3s ease-in-out;
        }
        ...
        .small-box.bg-warning {
            background: linear-gradient(45deg, #ffda6a, #fbc531) !important; /* Adjusted warning gradient */
        }

        .small-box.bg-success {
            background: linear-gradient(45deg, #29c7ac, #1abc9c) !important; /* Adjusted success gradient */
        }

        .small-box.bg-danger {
            background: linear-gradient(45deg, #fc5c65, #eb3b5a) !important; /* Adjusted danger gradient */
        }

        /* Style for Bulk Actions button */
        #bulk-action-button {
            font-weight: 500; /* Adjusted font weight */
            border-radius: 0.4rem; /* Match form elements */
        ...
        .form-group .btn-primary {
            border-radius: 0.4rem; /* Match form inputs */
        ...
        .badge {
            ...
            vertical-align: middle; /* Align vertically in tables */
        }
        ...
        .badge-info {
            background-color: #17a2b8; /* Standard Bootstrap info teal */
        }
    ...
    <style>
        ...
        .mb-3 {
            margin-bottom: 1rem !important; /* Standardize margin-bottom */
        }
        ...
        .form-control,
        .form-select {
             margin-bottom: 0.5rem; /* Space below input/select */
        }
        ...
        .table th,
        .table td {
            padding: 0.75rem; /* Adjust cell padding */
        ...
        /* Improve typography */
        body {
            font-family: 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; /* Use a modern, readable font stack */
            color: #333; /* Darker text for better contrast on light backgrounds */
        ...
        .form-label {
            font-size: 0.9rem; /* Slightly smaller labels than body text */
        }

        /* Ensure sidebar text color is readable against its background */
        .sidebar-animated .nav-link,
        .sidebar-animated .sidebar-heading {
            color: rgba(255, 255, 255, 0.9); /* White/light grey for contrast with gradient */
        }
