                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control @error('content') is-invalid @enderror" 
                                          id="ckeditor-content" name="content" rows="10" required>{{ old('content', $post->content) }}</textarea>
                                @error('content')
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="preview-image mt-2">
                                @if($post->thumbnail)
                                    <img id="thumbnail-preview" src="{{ Storage::url($post->thumbnail) }}" alt="Preview" class="img-fluid" style="max-height: 200px; display: block;">
                                @else
                                    <img id="thumbnail-preview" src="{{ asset('images/default-placeholder.png') }}" alt="Preview" class="img-fluid">
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" role="switch" id="allow_comments" 
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                          ...
                                          placeholder="Tối đa 160 ký tự">{{ old('meta_description', $post->meta_description) }}</textarea>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-paper-plane me-1"></i> Cập nhật bài viết
                    </button>
                </div>
            </div>
        </form>
...
<script>
    ...
    ClassicEditor
        ...
        .then(editor => {
            // Restore content if there are validation errors
            @if(old('content'))
