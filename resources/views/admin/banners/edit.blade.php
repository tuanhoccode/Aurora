                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('position') is-invalid @enderror" 
                                                ...
                                                <option value="slider" {{ old('position', $banner->position) == 'slider' ? 'selected' : '' }}>Slider</option>
                                                <option value="banner" {{ old('position', $banner->position) == 'banner' ? 'selected' : '' }}>Banner</option>
                                            </select>
                                            @error('position')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-text">
                                                <small class="text-muted">
                                                    Thứ tự hiện tại: {{ $banner->sort_order }} | 
                                                    Thứ tự cao nhất: {{ \App\Models\Banner::max('sort_order') }}
                                                </small>
                                            </div>
                                        </div>
                                    </div>
