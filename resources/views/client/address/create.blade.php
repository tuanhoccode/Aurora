            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="tp-checkout-place white-bg p-4">
                        <h3 class="tp-checkout-place-title">Thêm địa chỉ mới</h3>
                        @if ($errors->any())
                        ...
                        <form action="{{ route('address.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control"
                                    value="{{ old('email', $user->email ?? '') }}" required aria-describedby="email-error">
                                @error('email')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="street" id="street" class="form-control"
                                    value="{{ old('street') }}" required pattern="^[A-Za-z0-9\s,À-ỹ]{5,255}$"
