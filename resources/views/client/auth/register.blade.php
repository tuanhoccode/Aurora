...
<section class="tp-login-area pb-140 p-relative z-index-1 fix">
   <div class="tp-login-shape">
      <img class="tp-login-shape-1" src="{{asset('assets2/img/login/login-shape-1.png')}}" alt="">
      <img class="tp-login-shape-2" src="{{asset('assets2/img/login/login-shape-2.png')}}" alt="">
      <img class="tp-login-shape-3" src="{{asset('assets2/img/login/login-shape-3.png')}}" alt="">
      <img class="tp-login-shape-4" src="{{asset('assets2/img/login/login-shape-4.png')}}" alt="">
   </div>
   <div class="container">
               ...
               <form action="{{route('register.post')}}" method="post">
                  ...
                  <div class="tp-login-option">
                     ...
                     <div class="tp-login-input-wrapper">
                        <div class="tp-login-input-box">
                           <div class="tp-login-input">
                              <input id="fullname" name="fullname" value="{{old('fullname')}}" type="text" placeholder="Nhập tên của bạn">
                           </div>
                        ...
                        <div class="tp-login-input-box">
                           <div class="tp-login-input">
                              <input id="email" name="email" value="{{old('email')}}" type="email" placeholder="aurora@mail.com">
                           </div>
                           <div class="tp-login-input-title">
                     ...
                     <div class="tp-login-bottom">
                        <button type="submit" class="tp-login-btn w-100">Đăng ký</button>
                     </div>
                  </div>
               </form>
            </div>
