                  ...
                  <div class="col-xl-6 col-lg-8">
                     <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                           ...
                           <p>Bạn chưa có tài khoản? <span><a href="register.html">Tạo một tài khoản miễn phí</a></span></p>
                        </div>
                           ...
                           <div class="tp-login-input-wrapper">
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="email" type="email" placeholder="aurora@mail.com">
                                 </div>
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input id="tp_password" type="password" placeholder="Nhập ít nhất 6 ký tự">
                                 </div>
