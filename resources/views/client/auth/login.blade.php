         ...
         <div class="col-xl-6 col-lg-8">
            <div class="tp-login-wrapper">
               <div class="tp-login-top text-center mb-30">
                  <h3 class="tp-login-title">Đăng nhập vào Aurora.</h3>
                  <p>Bạn chưa có tài khoản? <span><a href="{{route('showRegister')}}">Tạo một tài khoản miễn phí</a></span></p>
               </div>
                  ...
                  <div class="tp-login-input-wrapper">
                     <div class="tp-login-input-box">
                        <div class="tp-login-input">
                           <input id="email" name="email" type="email" placeholder="aurora@mail.com" value="{{old('email')}}">
                        </div>
