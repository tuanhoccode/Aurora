        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="profile__main-inner d-flex flex-wrap align-items-center">
                    <form id="avatar-upload-form" action="{{route('avatar')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="profile__main-thumb">
                            <img id="profile-avatar-img" src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('assets2/img/users/avatars.png') }}" alt="Avatar" style="width: 70px; height: 70px; ">
                            <div class="profile__main-thumb-edit">
                                <input id="profile-thumb-input" class="profile-img-popup" name="avatar" type="file">
                                <label for="profile-thumb-input"><i class="fa-light fa-camera"></i></label>
                            </div>
                            <div class="profile-thumb-spinner spinner-border spinner-border-sm text-primary" role="status" style="display: none; position: absolute; top: 50%; left: 50%; margin-top: -0.5rem; margin-left: -0.5rem;">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                        </div>
                        <div id="avatar-upload-error" class="error mt-2"></div>
                    </form>
