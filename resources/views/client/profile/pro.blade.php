    ...
    <div class="container">
        <div class="profile__inner p-relative">
            <div class="profile__shape">
                <img class="profile__shape-1" src="assets2/img/login/laptop.png" alt="">
                <img class="profile__shape-2" src="assets2/img/login/man.png" alt="">
                <img class="profile__shape-3" src="assets2/img/login/shape-1.png" alt="">
                <img class="profile__shape-4" src="assets2/img/login/shape-2.png" alt="">
                <img class="profile__shape-5" src="assets2/img/login/shape-3.png" alt="">
                <img class="profile__shape-6" src="assets2/img/login/shape-4.png" alt="">
            </div>
            <div class="row">
                                                ...
                                                <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                    <form action="{{route('avatar')}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="profile__main-thumb">
                                                            <img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('assets2/img/users/avatars.png') }}" alt="Avatar" style="width: 70px; height: 70px; ">
                                                            <div class="profile__main-thumb-edit">
                                                                <input id="profile-thumb-input" class="profile-img-popup" name="avatar" type="file" onchange="this.form.submit()">
                                                    ...
                                                    <div class="profile__main-content">
                                                        <h4 class="profile__main-title">Chào mừng <span style="color:  rgb(75, 54, 33);">{{Auth::user()->fullname}}</span></h4>
                                                        <p>Chào mừng bạn trở lại–hãy để mỗi đơn hàng là một niềm vui!</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="profile__main-logout text-sm-end">
                                                    <a class="tp-logout-btn" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                    ...
                                                    <div class="profile__main-info-icon">
                                                        <span>
                                                            ...
                                                            <div class="icon-secure">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 24 24" fill="currentColor">
                                                                    <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 2.18l7 3.11v5.71c0 4.55-2.91 
               8.73-7 9.94-4.09-1.21-7-5.39-7-9.94V6.29l7-3.11zM12 
               9a2 2 0 0 0-2 2v2h4v-2a2 2 0 0 0-2-2z" />
                                                                </svg>
                                                                
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <h4 class="profile__main-info-title">Bảo mật cao</h4>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6">
                                                <div class="profile__main-info-item">
                                                    ...
                                                    <h4 class="profile__main-info-title">Đặt hàng</h4>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-6">
                                                <div class="profile__main-info-item">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="profile__main-info-item">
                                                    ...
                                                    <h4 class="profile__main-info-title">Hộp quà</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <form action="{{route('updateProfile')}}" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <div class="profile__input-box">
                                                        <div class="profile__input">
                                                            <input type="text" name="address_phone_number" placeholder="Vui lòng nhập số điện thoại cá nhân 2" value="{{ old('address_phone_number', $user->address->phone_number ?? '') }}">
...
<script>
    // Khi chuyển tab, lưu ID của tab đang mở
    ...
    // Khi tải lại trang, kích hoạt lại tab đã mở trước đó
