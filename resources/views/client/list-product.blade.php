                                        ...
                                        <li class="d-flex justify-content-between mb-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="on_sale"
                                                    value="1" id="on_sale" {{ request('on_sale') ? 'checked' : '' }}>
                                            ...
                                            <li class="d-flex justify-content-between mb-10">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="category_ids[]"
                                                        ...
                                                        {{ collect(request('category_ids'))->contains($category->id) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                            ...
                                            <li class="mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="prices[]"
                                                        value="{{ $i }}" id="price_range_{{ $i }}"
                                                        {{ collect(request('prices'))->contains($i) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
