...
<style>
    ...
    @media (max-width: 991.98px) {
        ...
        .checkout__cart-header, .checkout__cart-item { 
    ...
    <div class="checkout__container">
        ...
        <div class="checkout__block checkout__shipping-method">
            ...
            <form action="{{ route('checkout.update') }}" method="POST" id="shippingForm">
                @csrf
                <div class="form-check mb-3 {{ old('shipping_type', session('shipping_type', 'thường')) === 'thường' ? 'selected' : '' }}">
                    ...
                    <p class="text-muted small mb-1">
                        Dự kiến giao hàng từ <strong>{{ \Carbon\Carbon::today()->addDays(2)->format('d/m/Y') }}</strong>
                ...
                <div class="form-check {{ old('shipping_type', session('shipping_type', 'thường')) === 'nhanh' ? 'selected' : '' }}">
