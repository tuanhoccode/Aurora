                    ...
                    @forelse($mainSliders as $slider)
                        <div
                            ...
                            <div class="tp-slider-2-shape">
                                <img class="tp-slider-2-shape-1"
                                    src="{{ asset('assets2/img/slider/2/shape/shape-1.png') }}" alt="">
                            </div>
                            <div class="container">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="tp-slider-content-2">
                                            ...
                                            <div class="tp-slider-btn-2">
                                                @if ($slider->link)
                                                    <a href="{{ $slider->link }}" class="tp-btn tp-btn-border">Xem chi
                                                        tiết</a>
                                                @else
                                                    <a href="{{ route('shop') }}" class="tp-btn tp-btn-border">Xem bộ
                                                        sưu tập</a>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="tp-slider-thumb-2-wrapper p-relative">
                                            <div class="tp-slider-thumb-2-shape">
                                                <img class="tp-slider-thumb-2-shape-1"
                                                    src="{{ asset('assets2/img/slider/2/shape/shape-2.png') }}"
                                                    alt="">
                                                <img class="tp-slider-thumb-2-shape-2"
                                                    src="{{ asset('assets2/img/slider/2/shape/shape-3.png') }}"
                                                    alt="">
                                            </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="tp-slider-content-2">
                                            ...
                                            <div class="tp-slider-btn-2">
                                                <a href="{{ route('shop') }}" class="tp-btn tp-btn-border">Xem bộ sưu
                                                    tập</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="tp-slider-thumb-2-wrapper p-relative">
                                            ...
                                            <div class="tp-slider-thumb-2 text-end">
                                                <span class="tp-slider-thumb-2-gradient"></span>
                                                <img src="{{ asset('assets2/img/slider/2/slider-1.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="swiper-wrapper">
                                @foreach ($bannerArea as $banner)
                                    <div class="swiper-slide">
                                        <div
                                            class="tp-banner-item-2 custom-banner-flex p-relative z-index-1 grey-bg-2 mb-20 fix">
                                    ...
                                    <div class="tp-product-content-2 pt-15">
                                        ...
                                        <div class="tp-product-price-wrapper-2">
                                            @if ($product->type === 'variant' && $product->variants->count() > 0)
                                                ...
                                                <span
                                                    class="tp-product-price-2 new-price">{{ number_format($variant->regular_price, 0, ',', '.') }}
                                                    <span style="color: red;">đ</span></span>
                                            @else
                                                <span
                                                    class="tp-product-price-2 new-price">{{ number_format($product->price, 0, ',', '.') }}
                                                    <span style="color: red;">đ</span></span>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="tp-product-item-2 mb-40">
                                ...
                                <div class="tp-product-content-2 pt-15">
                                    ...
                                    <div class="tp-product-price-wrapper-2">
                                        @if ($prod->type === 'variant' && $prod->variants->count() > 0)
                                            @php $variant = $prod->variants->first(); @endphp
                                            <span
                                                class="tp-product-price-2 new-price">{{ number_format($variant->regular_price, 0, ',', '.') }}
                                                <span style="color: red;">₫</span></span>
                                        @else
                                            <span
                                                class="tp-product-price-2 new-price">{{ number_format($prod->price, 0, ',', '.') }}
                                                <span style="color: red;">₫</span></span>
                                        @endif
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tp-seller-more text-center mt-10">
                            <a href="{{ route('shop') }}" class="tp-btn tp-btn-border tp-btn-border-sm">Xem tất cả
                                sản phẩm</a>
                        </div>
                    </div>
                </div>
