                              ...
                              <div class="tp-banner-item-2 custom-banner-flex p-relative z-index-1 grey-bg-2 mb-20 fix">
                                 ...
                                 <div class="custom-banner-img">
                                    @if($category->icon)
                                       ...
                                       @endif
                                    @else
                                       <img src="{{ asset('assets2/img/product/product-1.jpg') }}" alt="{{ $category->name }}">
                                    @endif
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="tp-product-item-2 mb-40">
                           ...
                           <div class="tp-product-content-2 pt-15">
                              ...
                              <h3 class="tp-product-title-2"
                                 ...
                                 <a href="{{ route('client.product.show', ['slug' => $product->slug]) }}"
                                    style="display: inline-block; max-width: 100%; overflow: hidden; text-overflow: ellipsis;">{{ $product->name }}</a>
                              </h3>
                              @php
                              ...
                              <div class="tp-product-price-wrapper-2">
                                 <span
                                    class="tp-product-price-2 new-price">{{ number_format($product->display_price, 0, ',', '.') }}
