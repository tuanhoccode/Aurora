                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                           <div class="tp-slider-thumb-2-wrapper p-relative">
                              <div class="tp-slider-thumb-2-shape">
                                 <img class="tp-slider-thumb-2-shape-1" src="{{asset('assets2/img/slider/2/shape/shape-2.png')}}" alt="">
                                 <img class="tp-slider-thumb-2-shape-2" src="{{asset('assets2/img/slider/2/shape/shape-3.png')}}" alt="">
                              </div>
            ...
            <div class="row tp-gx-20">
               <div class="col-xxl-4 col-lg-6">
                  <div class="tp-banner-item-2 p-relative z-index-1 grey-bg-2 mb-20 fix">
                     <div class="tp-banner-thumb-2 include-bg transition-3" data-background="{{asset('assets2/img/banner/2/banner-1.jpg')}}"></div>
               ...
               <div class="col-xxl-4 col-lg-6">
                  <div class="tp-banner-item-2 p-relative z-index-1 grey-bg-2 mb-20 fix">
                     <div class="tp-banner-thumb-2 include-bg transition-3" data-background="{{asset('assets2/img/banner/2/banner-2.jpg')}}"></div>
                     <h3 class="tp-banner-title-2">
               ...
               <div class="col-xxl-4 col-lg-6">
                  <div class="tp-banner-item-2 p-relative z-index-1 grey-bg-2 mb-20 fix">
                     <div class="tp-banner-thumb-2 include-bg transition-3" data-background="{{asset('assets2/img/banner/2/banner-3.jpg')}}"></div>
                     <h3 class="tp-banner-title-2">
                        ...
                        <div class="swiper-wrapper">
                           <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                              <div class="tp-category-thumb-2">
                                 <a href="#">
                                    <img src="{{asset('assets2/img/category/category-1.jpg')}}" alt="">
                                 </a>
                              </div>
                           ...
                           <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                              <div class="tp-category-thumb-2">
                                 <a href="#">
                                    <img src="{{asset('assets2/img/category/category-2.jpg')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-category-content-2">
                                 <span>From $34.95</span>
                           ...
                           <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                              <div class="tp-category-thumb-2">
                                 <a href="#">
                                    <img src="{{asset('assets2/img/category/category-3.jpg')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-category-content-2">
                                 <span>From $34.95</span>
                           ...
                           <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                              <div class="tp-category-thumb-2">
                                 <a href="#">
                                    <img src="{{asset('assets2/img/category/category-4.jpg')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-category-content-2">
                                 <span>From $34.95</span>
                           ...
                           <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                              <div class="tp-category-thumb-2">
                                 <a href="#">
                                    <img src="{{asset('assets2/img/category/category-5.jpg')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-category-content-2">
                                 <span>From $34.95</span>
                           ...
                           <div class="tp-category-item-2 p-relative z-index-1 text-center swiper-slide">
                              <div class="tp-category-thumb-2">
                                 <a href="#">
                                    <img src="{{asset('assets2/img/category/category-6.jpg')}}" alt="">
                                 </a>
                              </div>
                              <div class="tp-category-content-2">
                                 <span>From $34.95</span>
                        ...
                        <div class="row">
                              ...
                              <div class="tp-product-item-2 mb-40">
                                 <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="product-details.html">
                                       <img src="{{asset('assets2/img/product/2/prodcut-1.jpg')}}" alt="">
                                    </a>
                                    <!-- product action -->
                           ...
                           <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                              <div class="tp-product-item-2 mb-40">
                                 <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="product-details.html">
                                       <img src="{{asset('assets2/img/product/2/prodcut-2.jpg')}}" alt="">
                                    </a>
                                    <!-- product action -->
                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                       <div class="tp-product-action-item-2 d-flex flex-column">
                           ...
                           <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                              <div class="tp-product-item-2 mb-40">
                                 <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="product-details.html">
                                       <img src="{{asset('assets2/img/product/2/prodcut-3.jpg')}}" alt="">
                                    </a>
                                    <!-- product action -->
                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                       <div class="tp-product-action-item-2 d-flex flex-column">
                           ...
                           <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                              <div class="tp-product-item-2 mb-40">
                                 <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="product-details.html">
                                       <img src="{{asset('assets2/img/product/2/prodcut-4.jpg')}}" alt="">
                                    </a>
                                    <!-- product action -->
                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                       <div class="tp-product-action-item-2 d-flex flex-column">
                           ...
                           <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                              <div class="tp-product-item-2 mb-40">
                                 <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="product-details.html">
                                       <img src="{{asset('assets2/img/product/2/prodcut-5.jpg')}}" alt="">
                                    </a>
                                    <!-- product action -->
                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                       <div class="tp-product-action-item-2 d-flex flex-column">
                           ...
                           <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                              <div class="tp-product-item-2 mb-40">
                                 <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="product-details.html">
                                       <img src="{{asset('assets2/img/product/2/prodcut-6.jpg')}}" alt="">
                                    </a>
                                    <!-- product action -->
                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                       <div class="tp-product-action-item-2 d-flex flex-column">
                           ...
                           <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                              <div class="tp-product-item-2 mb-40">
                                 <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="product-details.html">
                                       <img src="{{asset('assets2/img/product/2/prodcut-7.jpg')}}" alt="">
                                    </a>
                                    <!-- product action -->
                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                       <div class="tp-product-action-item-2 d-flex flex-column">
                           ...
                           <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                              <div class="tp-product-item-2 mb-40">
                                 <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                    <a href="product-details.html">
                                       <img src="{{asset('assets2/img/product/2/prodcut-8.jpg')}}" alt="">
                                    </a>
                                    <!-- product action -->
                                    <div class="tp-product-action-2 tp-product-action-blackStyle">
                                       <div class="tp-product-action-item-2 d-flex flex-column">
                     ...
                     <div class="tp-featured-slider-active swiper-container">
                        <div class="swiper-wrapper">
                           <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                              <div class="tp-featured-thumb include-bg" data-background="{{asset('assets2/img/product/slider/product-slider-1.jpg')}}"></div>
                           ...
                           <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                              <div class="tp-featured-thumb include-bg" data-background="{{asset('assets2/img/product/slider/product-slider-2.jpg')}}"></div>
                              <div class="tp-featured-content">
                                 <h3 class="tp-featured-title">
                           ...
                           <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                              <div class="tp-featured-thumb include-bg" data-background="{{asset('assets2/img/product/slider/product-slider-3.jpg')}}"></div>
                              <div class="tp-featured-content">
                                 <h3 class="tp-featured-title">
                           ...
                           <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                              <div class="tp-featured-thumb include-bg" data-background="{{asset('assets2/img/product/slider/product-slider-4.jpg')}}"></div>
                              <div class="tp-featured-content">
                                 <h3 class="tp-featured-title">
                           ...
                           <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                              <div class="tp-featured-thumb include-bg" data-background="{{asset('assets2/img/product/slider/product-slider-5.jpg')}}"></div>
                              <div class="tp-featured-content">
                                 <h3 class="tp-featured-title">
            ...
            <div class="row justify-content-center">
                           ...
                           <div class="swiper-wrapper">
                              <div class="tp-trending-item swiper-slide">
                                 <div class="tp-product-item-2">
                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                       <a href="product-details.html">
                                          <img src="{{asset('assets2/img/product/trending/trending-1.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-2 tp-product-action-blackStyle">
                                          <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-trending-item swiper-slide">
                                 <div class="tp-product-item-2">
                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                       <a href="product-details.html">
                                          <img src="{{asset('assets2/img/product/trending/trending-2.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-2 tp-product-action-blackStyle">
                                          <div class="tp-product-action-item-2 d-flex flex-column">
                              ...
                              <div class="tp-trending-item swiper-slide">
                                 <div class="tp-product-item-2">
                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                       <a href="product-details.html">
                                          <img src="{{asset('assets2/img/product/trending/trending-3.jpg')}}" alt="">
                                       </a>
                                       <!-- product action -->
                                       <div class="tp-product-action-2 tp-product-action-blackStyle">
                                          <div class="tp-product-action-item-2 d-flex flex-column">
               ...
               <div class="col-xl-4 col-lg-5 col-md-8 col-sm-10">
                  <div class="tp-trending-banner p-relative ml-35">
                     <div class="tp-trending-banner-thumb w-img include-bg" data-background="{{asset('assets2/img/product/trending/banner/trending-banner.jpg')}}"></div>
            ...
            <div class="row">
                  ...
                  <div class="tp-blog-item-2 mb-40">
                     <div class="tp-blog-thumb-2 p-relative fix">
                        <a href="blog-details.html">
                           <img src="{{asset('assets2/img/blog/2/blog-1.jpg')}}" alt="">
                        </a>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-blog-item-2 mb-40">
                     <div class="tp-blog-thumb-2 p-relative fix">
                        <a href="blog-details.html">
                           <img src="{{asset('assets2/img/blog/2/blog-2.jpg')}}" alt="">
                        </a>
                        <div class="tp-blog-meta-date-2">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-blog-item-2 mb-40">
                     <div class="tp-blog-thumb-2 p-relative fix">
                        <a href="blog-details.html">
                           <img src="{{asset('assets2/img/blog/2/blog-3.jpg')}}" alt="">
                        </a>
                        <div class="tp-blog-meta-date-2">
            ...
            <div class="row row-cols-lg-5 row-cols-sm-2 row-cols-1 gx-2 gy-2 gy-lg-0">
               <div class="col">
                  <div class="tp-instagram-item-2 w-img">
                     <img src="{{asset('assets2/img/instagram/2/insta-1.jpg')}}" alt="">
                     <div class="tp-instagram-icon-2">
                        <a href="{{asset('assets2/img/instagram/2/insta-1.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                     </div>
                  </div>
               </div>
               <div class="col">
                  <div class="tp-instagram-item-2 w-img">
                     <img src="{{asset('assets2/img/instagram/2/insta-2.jpg')}}" alt="">
                     <div class="tp-instagram-icon-2">
                        <a href="{{asset('assets2/img/instagram/2/insta-2.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                     </div>
                  </div>
               </div>
               <div class="col">
                  <div class="tp-instagram-banner text-center">
                     <div class="tp-instagram-banner-icon mb-40">
                        <a href="#">
                           <img src="{{asset('assets2/img/instagram/2/insta-icon.png')}}" alt="">
                        </a>
                     </div>
               ...
               <div class="col">
                  <div class="tp-instagram-item-2 w-img">
                     <img src="{{asset('assets2/img/instagram/2/insta-3.jpg')}}" alt="">
                     <div class="tp-instagram-icon-2">
                        <a href="{{asset('assets2/img/instagram/2/insta-3.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                     </div>
                  </div>
               </div>
               <div class="col">
                  <div class="tp-instagram-item-2 w-img">
                     <img src="{{asset('assets2/img/instagram/2/insta-4.jpg')}}" alt="">
                     <div class="tp-instagram-icon-2">
                        <a href="{{asset('assets2/img/instagram/2/insta-4.jpg')}}" class="popup-image"><i class="fa-brands fa-instagram"></i></a>
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <nav>
                        <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                           <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                              <img src="{{asset('assets2/img/product/details/3/nav/product-details-nav-1.jpg')}}" alt="">
                           </button>
                           <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                              <img src="{{asset('assets2/img/product/details/3/nav/product-details-nav-2.jpg')}}" alt="">
                           </button>
                           <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                              <img src="{{asset('assets2/img/product/details/3/nav/product-details-nav-3.jpg')}}" alt="">
                           </button>
                           <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                              <img src="{{asset('assets2/img/product/details/3/nav/product-details-nav-4.jpg')}}" alt="">
                           </button>
                        </div>
                     </nav>
                     <div class="tab-content m-img" id="productDetailsNavContent">
                        <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{asset('assets2/img/product/details/3/main/product-details-main-1.jpg')}}" alt="">
                           </div>
                        </div>
                        <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{asset('assets2/img/product/details/3/main/product-details-main-2.jpg')}}" alt="">
                           </div>
                        </div>
                        <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{asset('assets2/img/product/details/3/main/product-details-main-3.jpg')}}" alt="">
                           </div>
                        </div>
                        <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                           <div class="tp-product-details-nav-main-thumb">
                              <img src="{{asset('assets2/img/product/details/3/main/product-details-main-4.jpg')}}" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
