                                    ...
                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-xl-5">
                                          ...
                                          <div class="home-menu-item ">
                                             <a href="index.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="{{asset('assets2/img/menu/menu-home-1.jpg')}}" alt="">
                                                </div>
                                       ...
                                       <div class="col">
                                          <div class="home-menu-item ">
                                             <a href="index-2.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="{{asset('assets2/img/menu/menu-home-2.jpg')}}" alt="">
                                                </div>
                                                <div class="home-menu-content">
                                       ...
                                       <div class="col">
                                          <div class="home-menu-item ">
                                             <a href="index-3.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="{{asset('assets2/img/menu/menu-home-3.jpg')}}" alt="">
                                                </div>
                                                <div class="home-menu-content">
                                       ...
                                       <div class="col">
                                          <div class="home-menu-item ">
                                             <a href="index-4.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="{{asset('assets2/img/menu/menu-home-4.jpg')}}" alt="">
                                                </div>
                                                <div class="home-menu-content">
                                       ...
                                       <div class="col">
                                          <div class="home-menu-item ">
                                             <a href="index-5.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                   <img src="{{asset('assets2/img/menu/menu-home-5.jpg')}}" alt="">
                                                </div>
                                                <div class="home-menu-content">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-3">
                                          <div class="shop-mega-menu-img">
                                             <img src="{{asset('assets2/img/menu/product/menu-product-img-1.jpg')}}" alt="">
                                       ...
                                       <div class="col-lg-3">
                                          <div class="shop-mega-menu-img">
                                             <img src="{{asset('assets2/img/menu/product/menu-product-img-2.jpg')}}" alt="">
                                             <div class="shop-mega-menu-btn">
                              ...
                              <li class="has-dropdown">
                                 ...
                                 <ul class="mega-menu tp-submenu">
                                    <li>
                                       ...
                                       <ul>
                                          <li>
                                             <a href="shop.html"><img src="{{asset('assets2/img/header/menu/menu-1.jpg')}}" alt=""></a>
                                          </li>
                                          <li>
                                    ...
                                    <li>
                                       ...
                                       <ul>
                                          <li>
                                             <a href="shop.html"><img src="{{asset('assets2/img/header/menu/menu-2.jpg')}}" alt=""></a>
                                          </li>
                                          <li>
                                    ...
                                    <li>
                                       ...
                                       <ul>
                                          <li>
                                             <a href="shop.html"><img src="{{asset('assets2/img/header/menu/menu-3.jpg')}}" alt=""></a>
                                          </li>
                                          <li>
...
$(document).ready(function() {
    $('input[name="price_ranges[]"]').on('change', function() {
        if (this.checked) {
            $('input[name="price_ranges[]"]').not(this).prop('checked', false);
        }
    });
});
</script>